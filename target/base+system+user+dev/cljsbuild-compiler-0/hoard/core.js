...
if(typeof hoard.core.t20343 !== 'undefined'){
} else {

/**
* @constructor
*/
hoard.core.t20343 = (function (owner,user,user_being_indexed,meta20344){
this.owner = owner;
this.user = user;
...
hoard.core.t20343.prototype.om$core$IRender$ = true;

hoard.core.t20343.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return React.DOM.li(null,self__.user);
});

hoard.core.t20343.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20345){
var self__ = this;
var _20345__$1 = this;
return self__.meta20344;
});

hoard.core.t20343.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20345,meta20344__$1){
var self__ = this;
var _20345__$1 = this;
return (new hoard.core.t20343(self__.owner,self__.user,self__.user_being_indexed,meta20344__$1));
});

hoard.core.t20343.cljs$lang$type = true;

hoard.core.t20343.cljs$lang$ctorStr = "hoard.core/t20343";

hoard.core.t20343.cljs$lang$ctorPrWriter = (function (this__4384__auto__,writer__4385__auto__,opt__4386__auto__){
return cljs.core._write.call(null,writer__4385__auto__,"hoard.core/t20343");
});

hoard.core.__GT_t20343 = (function __GT_t20343(owner__$1,user__$1,user_being_indexed__$1,meta20344){
return (new hoard.core.t20343(owner__$1,user__$1,user_being_indexed__$1,meta20344));
});

}

return (new hoard.core.t20343(owner,user,user_being_indexed,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),26,new cljs.core.Keyword(null,"end-line","end-line",1837326455),28,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),25,new cljs.core.Keyword(null,"file","file",-1269645878),"/Users/blischalk/node-webkit-apps/hoard/src/cljs/hoard/core.cljs"], null)));
});
hoard.core.users_being_indexed = (function users_being_indexed(_,p__20346){
var map__20348 = p__20346;
var map__20348__$1 = ((cljs.core.seq_QMARK_.call(null,map__20348))?cljs.core.apply.call(null,cljs.core.hash_map,map__20348):map__20348);
var users = cljs.core.get.call(null,map__20348__$1,new cljs.core.Keyword(null,"users","users",-713552705));
...
hoard.core.handle_screen_name_change = (function handle_screen_name_change(e,owner,p__20349){
var map__20351 = p__20349;
var map__20351__$1 = ((cljs.core.seq_QMARK_.call(null,map__20351))?cljs.core.apply.call(null,cljs.core.hash_map,map__20351):map__20351);
var screen_name = cljs.core.get.call(null,map__20351__$1,new cljs.core.Keyword(null,"screen-name","screen-name",31129652));
...
var G__20353 = (((type instanceof cljs.core.Keyword))?type.fqn:null);
switch (G__20353) {
case "user-indexed":
...
return om.dom.input.call(null,{"onChange": (function (p1__20355_SHARP_){
return hoard.core.handle_screen_name_change.call(null,p1__20355_SHARP_,owner,state);
...
if(typeof hoard.core.t20392 !== 'undefined'){
} else {

/**
* @constructor
*/
hoard.core.t20392 = (function (owner,data,indexing_ui,meta20393){
this.owner = owner;
this.data = data;
...
hoard.core.t20392.prototype.om$core$IRenderState$ = true;

hoard.core.t20392.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,p__20395){
var self__ = this;
...
var state = map__20396__$1;
var comm = cljs.core.get.call(null,map__20396__$1,new cljs.core.Keyword(null,"comm","comm",-1689770614));
var this$__$1 = this;
return hoard.core.main_view.call(null,self__.owner,state,comm);
});

hoard.core.t20392.prototype.om$core$IInitState$ = true;

hoard.core.t20392.prototype.om$core$IInitState$init_state$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
hoard.core.t20392.prototype.om$core$IWillMount$ = true;

hoard.core.t20392.prototype.om$core$IWillMount$will_mount$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
return (function (state_20412){
var state_val_20413 = (state_20412[(1)]);
if((state_val_20413 === (7))){
var inst_20401 = (state_20412[(2)]);
var inst_20402 = cljs.core.nth.call(null,inst_20401,(0),null);
var inst_20403 = cljs.core.nth.call(null,inst_20401,(1),null);
var inst_20404 = hoard.core.handle_event.call(null,inst_20402,self__.owner,inst_20403,comm);
var state_20412__$1 = (function (){var statearr_20414 = state_20412;
(statearr_20414[(7)] = inst_20404);

return statearr_20414;
})();
var statearr_20415_20428 = state_20412__$1;
(statearr_20415_20428[(2)] = null);

(statearr_20415_20428[(1)] = (2));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_20413 === (6))){
var inst_20408 = (state_20412[(2)]);
var state_20412__$1 = state_20412;
var statearr_20416_20429 = state_20412__$1;
(statearr_20416_20429[(2)] = inst_20408);

(statearr_20416_20429[(1)] = (3));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_20413 === (5))){
var state_20412__$1 = state_20412;
var statearr_20417_20430 = state_20412__$1;
(statearr_20417_20430[(2)] = null);

(statearr_20417_20430[(1)] = (6));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_20413 === (4))){
var state_20412__$1 = state_20412;
return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_20412__$1,(7),comm);
} else {
if((state_val_20413 === (3))){
var inst_20410 = (state_20412[(2)]);
var state_20412__$1 = state_20412;
return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_20412__$1,inst_20410);
} else {
if((state_val_20413 === (2))){
var state_20412__$1 = state_20412;
var statearr_20418_20431 = state_20412__$1;
(statearr_20418_20431[(1)] = (4));
...
var state_20412__$1 = state_20412;
var statearr_20420_20432 = state_20412__$1;
(statearr_20420_20432[(2)] = null);

(statearr_20420_20432[(1)] = (2));
...
var statearr_20424 = [null,null,null,null,null,null,null,null];
(statearr_20424[(0)] = state_machine__6526__auto__);

(statearr_20424[(1)] = (1));

return statearr_20424;
});
var state_machine__6526__auto____1 = (function (state_20412){
while(true){
var ret_value__6527__auto__ = (function (){try{while(true){
var result__6528__auto__ = switch__6525__auto__.call(null,state_20412);
...
}catch (e20425){if((e20425 instanceof Object)){
var ex__6529__auto__ = e20425;
var statearr_20426_20433 = state_20412;
(statearr_20426_20433[(5)] = ex__6529__auto__);


cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_20412);
...
var G__20434 = state_20412;
state_20412 = G__20434;
continue;
} else {
...
state_machine__6526__auto__ = function(state_20412){
switch(arguments.length){
case 0:
return state_machine__6526__auto____0.call(this);
case 1:
return state_machine__6526__auto____1.call(this,state_20412);
}
...
var state__6583__auto__ = (function (){var statearr_20427 = f__6582__auto__.call(null);
(statearr_20427[cljs.core.async.impl.ioc_helpers.USER_START_IDX] = c__6581__auto__);
...
hoard.core.t20392.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20394){
var self__ = this;
var _20394__$1 = this;
return self__.meta20393;
});

hoard.core.t20392.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20394,meta20393__$1){
var self__ = this;
var _20394__$1 = this;
return (new hoard.core.t20392(self__.owner,self__.data,self__.indexing_ui,meta20393__$1));
});

hoard.core.t20392.cljs$lang$type = true;

hoard.core.t20392.cljs$lang$ctorStr = "hoard.core/t20392";

hoard.core.t20392.cljs$lang$ctorPrWriter = (function (this__4384__auto__,writer__4385__auto__,opt__4386__auto__){
return cljs.core._write.call(null,writer__4385__auto__,"hoard.core/t20392");
});

hoard.core.__GT_t20392 = (function __GT_t20392(owner__$1,data__$1,indexing_ui__$1,meta20393){
return (new hoard.core.t20392(owner__$1,data__$1,indexing_ui__$1,meta20393));
});

}

return (new hoard.core.t20392(owner,data,indexing_ui,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),37,new cljs.core.Keyword(null,"end-line","end-line",1837326455),124,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),103,new cljs.core.Keyword(null,"file","file",-1269645878),"/Users/blischalk/node-webkit-apps/hoard/src/cljs/hoard/core.cljs"], null)));
});
